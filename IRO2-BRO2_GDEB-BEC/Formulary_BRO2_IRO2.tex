\documentclass[a4paper,7pt]{extarticle} % 10pt - 30% = 7pt
...
\mybox{\textbf{Allgemeine Eigenschaften / \textit{General properties}}}{
      \begin{description}
            \item [Permittivität / \textit{Permittivity}]\leavevmode\\
            ...
            \item [Energie / \textit{Energy}]
                  \[\Delta W\sub{ab}  =-Q\,\int_{a}^{b}\vec{E}\vdot\dd\vec{r}=Q\,\left(\varphi\sub{b}-\varphi\sub{a}\right)=-Q\,U\sub{ab}\quad [W]=\unit{\joule}=\unit{\kilogram\meter\squared\per\second\squared}\]
...
\mybox{\textbf{Kondensatoren / \textit{Capacitors}}}{
      \begin{description}
            ...
            \item [Kugelkondensator / \textit{Spherical capacitor} $R\sub{1}<R\sub{2}$]
                  \[ C =\frac{4\,\pi\,\varepsilon}{\frac{1}{R\sub{1}}-\frac{1}{R\sub{2}}}\]
...
\mybox{\textbf{Allgemeine magnetische Felder / \textit{General magnetic fields}}}{
      \begin{description}
            \item [Permeabilität / \textit{Permeability}]\leavevmode\\
            ...
            \item [Lorentz-Kraft / \textit{Lorentz force}]\leavevmode\\
                  \begin{itemize}
                        ...
                        \item Bewegung senkrecht zum Magnetfeld / \textit{Motion perpendicular to magnetic field}
                              \[\norm{\vec{F}}=\abs{Q}\,\norm{\vec{v}}\,\norm{\vec{B}}\]
